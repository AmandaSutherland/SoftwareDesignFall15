...
class SwimFishModel:
    ...
    def __init__(self):
        ...
        self.monsters = []
        self.choices = ['images/octopus1_png.png',  'images/crab1.png',
                        'images/jellyfish.png',  'images/shark.png',
                        'images/stingray.png']
...
class Monster:
    ...
    def __init__(self, height, width, img, x, y):
        ...
        self.scale = pygame.transform.scale(self.img,  (int(width),
                                            int(height)))
        self.x = x
        self.y = y
        #Adjust the positions of rectangles surrounding the
        #monsters to give a smoother game play experience
        self.rect = pygame.Rect(x+60, y, width, height)

    def move_monster(self):
        """ Describes how the monsters and their encapsulating
            rectangles move """
        ...
        #480 is the total height of the screen set in the execution program
        height_pixel = 480/screen_height_sections
